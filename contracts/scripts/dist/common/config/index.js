  ...
  CHAINS: [{
    ...
    OPTIONS: [{
      ...
      CONTRACTS: [{
        ...
        UPDATE_MSG: toJson({
          update_config: {
            offchain_clock: [ADDRESS.ADMIN, ADDRESS.WORKER, ADDRESS.LIQUIDATION_WORKER],
            lending_platform: $("OPTIONS[CHAIN_ID=harpoon-4]|CONTRACTS[WASM=lending_platform.wasm]|ADDRESS")
          }
        }),
        CODE: 3269,
        ADDRESS: "kujira1sj3k6f5e2nxx8cvu3rrq6f8pzyl40e0nkeffmhen23kqrnvltwnse4cz7h"
      }, {
        ...
        CODE: 3294,
        ADDRESS: "kujira1hywaw7mzn89temhe0u0gyyfs7uc6hlj098a7lxt8cuhdsgyehwtshl5dqg"
      }, {
        WASM: "oracle.wasm",
        LABEL: "oracle",
        INIT_MSG: toJson({}),
        ...
        CODE: 3271,
        ADDRESS: "kujira1k05d6rwgnfxv5vz76dn4563lmejs9hj3kex0rkae4vhjn2nm3umshvjzla"
      }, {
        ...
        INIT_MSG: toJson({
          main_currency: {
            token: {
              native: {
                denom: $("OPTIONS[CHAIN_ID=harpoon-4]|DENOM")
              }
            },
            decimals: 6
          }
        ...
        UPDATE_MSG: toJson({
          update_address_config: {
            worker: ADDRESS.WORKER,
            oracle: $("OPTIONS[CHAIN_ID=harpoon-4]|CONTRACTS[WASM=oracle.wasm]|ADDRESS"),
            minter: $("OPTIONS[CHAIN_ID=harpoon-4]|CONTRACTS[WASM=minter_kujira.wasm]|ADDRESS"),
            scheduler: $("OPTIONS[CHAIN_ID=harpoon-4]|CONTRACTS[WASM=adapter_scheduler_kujira.wasm]|ADDRESS")
          }
        }),
        CODE: 3314,
        ADDRESS: "kujira1cdas5s8m7zpl7wdujmgkd60lzh0w5haane54hmzydlmwf3ua90xq50nv8m"
      }],
      IBC: []
    }]
  }, {
      ...
      CONTRACTS: [{
        ...
        INIT_MSG: toJson({
          main_currency: {
            token: {
              native: {
                denom: $("OPTIONS[CHAIN_ID=stargaze-0]|DENOM")
              }
            },
            decimals: 6
          }
      ...
      CONTRACTS: [{
        ...
        INIT_MSG: toJson({
          main_currency: {
            token: {
              native: {
                denom: $("OPTIONS[CHAIN_ID=elgafar-1]|DENOM")
              }
            },
            decimals: 6
          }
        ...
        UPDATE_MSG: toJson({
          update_address_config: {
            oracle: $("OPTIONS[CHAIN_ID=elgafar-1]|CONTRACTS[WASM=oracle.wasm]|ADDRESS")
          }
        }),
        CODE: 3601,
      ...
      CONTRACTS: [{
        ...
        INIT_MSG: toJson({
          main_currency: {
            token: {
              native: {
                denom: $("OPTIONS[CHAIN_ID=stargaze-1]|DENOM")
              }
            },
            decimals: 6
          }
        ...
        UPDATE_MSG: toJson({
          update_address_config: {
            oracle: $("OPTIONS[CHAIN_ID=stargaze-1]|CONTRACTS[WASM=oracle.wasm]|ADDRESS")
          }
        }),
        CODE: 0,
        ADDRESS: ""
